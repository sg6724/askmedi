        ...
        children: [
            ...
            child: ListView(
              ...
              children: [
                ...
                for (final (i, entry) in state.entries.indexed)
                  switch (entry) {
                    UserEntry(:final text) => _Bubble(text: text, fromUser: true),
                ...
                if (state.error != null)
                  ErrorBanner(apiErrorMessage(l10n, state.error!.$1),
          ...
          if (state.voice != VoiceStatus.idle)
            Padding(
              ...
              child: Text(
                state.voice == VoiceStatus.recording ? l10n.listening : l10n.transcribing,
...
class _DisclosureBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
            color: AppColors.lavender, borderRadius: BorderRadius.circular(12)),
        child: Row(children: [
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        if (followup != null) ...[
          if (followup.question.isNotEmpty && followup.question != reply.message)
