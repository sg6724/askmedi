...
final displayNameProvider = FutureProvider.autoDispose<String?>((ref) async {
  final row = await ref
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final actions = [
      (
        ...
        l10n.homeCheckSymptoms,
        l10n.homeCheckSymptomsSub,
        AppColors.sky,
        Routes.chat,
      ),
      (
      ...
      (
        ...
        l10n.homeScanMedicine,
        l10n.homeScanMedicineSub,
        AppColors.tealLight,
        Routes.medicine,
      ),
      (
        Icons.description_outlined,
        l10n.homeUploadReport,
        l10n.homeUploadReportSub,
        AppColors.peach,
        Routes.report,
      ),
      (
        Icons.local_hospital_outlined,
        l10n.homeFindHospital,
        l10n.homeFindHospitalSub,
        AppColors.blush,
        Routes.hospitals,
      ),
    ];
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            name == null ? l10n.greetingNoName : l10n.greeting(name),
